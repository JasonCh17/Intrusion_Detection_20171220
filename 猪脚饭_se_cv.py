...
for train, test in skf.split(X_se,y_se):
    # 验证测试样本
    clf_4.fit(X_se[train], y_se[train])
    preditions_smoteenn = clf_4.predict(X_se[test])
    # #混淆矩阵
    class_names = ['DOS', 'Normal', 'Probing', 'R2L', 'U2R']
    from sklearn.metrics import confusion_matrix

    # cnf_matrix = confusion_matrix(y_3[test], preditions_base)
    # cnf_matrix_smote = confusion_matrix(y_s[test], preditions_smote)
    # cnf_matrix_enn=confusion_matrix(y_e[test],preditions_enn)
    cnf_matrix_smoteenn=confusion_matrix(y_se[test],preditions_smoteenn)
    # class_names=['DOS','Normal','Probing','R2L','U2R']
    plt.figure()
    ...
    # print(" SMOTE")
    # print(test_mean_1)
    # print(classification_report(y_s[test], preditions_smote, target_names=class_names, digits=6))
    # print("--------------------------------------------------------------------------------")
    # print("ENN")
    # print(test_mean_2)
    # print(classification_report(y_e[test],preditions_enn,target_names=class_names,digits=6))
    # print("--------------------------------------------------------------------------------")
    print(" SMOTE+ENN")
    # print(test_mean_3)
    print(classification_report(y_se[test],preditions_smoteenn,target_names=class_names,digits=6))
    # print("--------------------------------------------------------------------------------")
    # ###########################################################################
